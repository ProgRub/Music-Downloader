...
namespace Business.Services
{
    public class GetLyricsAndYearService
    {
        ...
        public void StartThreads()
        {
            ...
            NotifyInitialThreadsConfiguration?.Invoke(this,new ThreadsConfigurationEventArgs{NumberOfThreads = NumberOfThreads,NumberOfFilesPerThread = filesPerThreadList});
        ...
        internal void ThreadFunction(object parameters)
        {
            ...
            var geniusDetailsScraper = new GeniusDetailsScraper((HashSet<SongFileDTO>)argArray.GetValue(1), (int) argArray.GetValue(0));
